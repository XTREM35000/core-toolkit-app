...
const TankForm: React.FC<TankFormProps> = ({ open, onOpenChange, initial = null, onSaved }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div role="dialog" aria-modal="true" aria-label={initial ? 'Éditer un bac' : 'Créer un bac'} className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        <h3 className="text-lg font-semibold mb-4">{initial ? 'Éditer un bac' : 'Créer un bac'}</h3>
